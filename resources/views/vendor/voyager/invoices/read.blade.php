...
@section('page_header')
    <h1 class="page-title">
        ...
        @if($invoice->status==0)
        <a href="{{url('admin/invoices/14'.'/update-status?status=1')}}" class="btn btn-success" style="margin-right:20px;padding:7px">
            <i class="glyphicon glyphicon-check"></i> <span>Approve</span>
        </a>
        @elseif($invoice->status==1)
        <a href="{{url('admin/invoices/14'.'/update-status?status=0')}}" class="btn btn-warning" style="padding:7px">
