...
class BillController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','vendors','categories','c_bills','bill_prefix','products'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $bill = Bill::find($dataTypeContent->id);
        $bill_products = BillProduct::where('bill_id',$dataTypeContent->id)->get();
        $vendors = Vendor::get();
        $categories = Category::where('type',3)->get();
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','bill','bill_products','vendors','categories','c_invoices','inv_prefix','products'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $debit_notes = DebitNote::where('bill_id',$bill->id)->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted','bill','bill_products','bill_prefix','bill_payments','debit_notes'));
    }
